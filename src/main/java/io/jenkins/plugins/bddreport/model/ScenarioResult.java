package io.jenkins.plugins.bddreport.model;
...
public class ScenarioResult implements Serializable {
    ...
    public String computeStatus() {
        // If any hook or step failed -> failed
        ...
        // If any step is skipped/pending/undefined -> skipped
        for (StepResult step : steps) {
            String st = step.getStatus().toLowerCase();
